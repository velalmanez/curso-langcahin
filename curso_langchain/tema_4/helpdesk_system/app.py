...
def procesar_consulta(consulta: str, ticket_id: str):
    ...
    try:
        for chunk in st.session_state.helpdesk.stream(
            estado_inicial, 
            config=config, 
            stream_mode="updates" # devuelve solo las actualizaciones del estado tras la ejecución de cada nodo
        ):
        ...
        with st.form("nueva_consulta"):
            ...
            if submitted and consulta.strip():
                ...
                with st.spinner("🔄 Procesando consulta..."):
                    # Inicia la ejecucion del grafo en modo streaming
